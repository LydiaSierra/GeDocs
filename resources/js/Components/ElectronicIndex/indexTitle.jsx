...
export default function IndexTitle({ activeSheetId, activeSheetNumber }) {
    return (
            ...
            >
                ...
                <Link href={route("explorer")}>
                    <div className="hidden md:flex items-center gap-3 mb-4 p-3 bg-white rounded-2xl">
                        <button className="flex items-center gap-2 text-xs font-black uppercase cursor-pointer tracking-widest text-gray-400 hover:text-primary transition-all group">
                ...
                <h2 className="text-2xl ml-3 font-medium">Indice Electrónico</h2>
            </div>
        </div>
    );
}
