            ...
            <div className="w-[50%] h-[70%] bg-white flex flex-col gap-5 relative rounded-md p-10">
                ...
                <div className=" w-full h-full flex flex-row items-center justify-between">
                    ...
                    <div className="w-[70%] h-full flex flex-col justify-start gap-5 items-center rounded-lg">
                        <div className="w-full h-[80%] grid grid-cols-2 grid-rows-4 gap-4 bg-[#F3F3F3] rounded-lg px-2 overflow-y-scroll pb-4">
                            <div className="p-4 rounded flex flex-col items-start">
                                <h1 className="font-light text-[17px]">
                                    Nombres
                                </h1>
                                <h2 className="font-semibold text-[18px]">
                                    {idSelected.name.split(" ")[0]}
                                </h2>
                            </div>
