...
export default function Sidebar() {
    ...
    return (<>
        <div
            className="hidden md:flex h-[calc(100dvh-80px)] w-20 bg-primary flex-col justify-between items-center py-5">
        ...
        <div
            className="md:hidden fixed bottom-0 left-0 w-full bg-primary flex justify-around items-center py-2 z-50">
            {links.map((link) => {
                return (<NavLink
                    key={link.id}
                    href={route(link.href)}
