...
const NotificationDropDown = () => {
    ...
    const { notifications, markAsReadNotification, loading, visibleDetails} = useContext(NotificationsContext);
    ...
    if(markAsReadNotification === null){
                ...
                <ul
                    ...
                    <li className="flex flex-col w-full h-[50%] gap-8 hover:bg-none">
                        <div className="w-[95%] self-center pl-3 h-auto border-b-2 border-black rounded-none">
                            <h2 className="text-[20px] text-black font-normal">
                        ...
                        <ul className="w-full h-auto">
                            {notifications.map((item) => {
                                ...
                                <li
                                    key={item.id}
                                    className="flex flex-row p-2 w-full gap-2 h-auto border-y border-x-none boder-[#DBDBDB] 
                                ...
                                >
                                    ...
                                    <div className="w-[80%] h-full flex flex-col items-start gap-1">
                                        ...
                                        <p className="text-[13px]">{`${item.data.user.name} solicita un nuevo acceso con...`}</p>
                                    </div>

                                    <div className="w-[10%] h-full flex justify-end items-start ">
                                        <p className=" text-black font-medium text-[12px] absolute top-5 right-3">
                        ...
                        >
                            <button
                                className="self-center cursor-pointer w-[40%] h-10 bg-none border-2 flex justify-center items-center 
                    ...
                    {/* <li className="flex flex-col w-full h-[50%] gap-8 hover:bg-none">
                        ...
                        <Link
                            ...
                            <button
                                className="self-center cursor-pointer w-[40%] h-10 bg-none border-2 flex justify-center items-center 
                        border-solid border-[#848484] rounded-2xl hover:border-none hover:bg-[#848484] hover:text-white"
                                onClick={() => setSolicitudAprendiz(true)}
                                >
                                Todas las Solicitudes
                            </button>
                        </Link>
