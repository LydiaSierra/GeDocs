    ...
    return (
        <div className={`${visibleDetails ? "grid-cols-3 grid gap-2" : "flex flex-col gap-2"} mt-2 w-full`}>
            <div className="col-span-1 h-full">
                ...
                <ul className="flex flex-col gap-3 overflow-y-scroll pr-2 mt-1 rounded-lg ">
                    ...
                    {notifications.map((item) => {
                        ...
                        return (
                            ...
                            <li
                                ...
                                className={`flex flex-row w-full h-auto border-y border-x-none ${item.read_at ? "text-[#848484] bg-white" : "text-black font-bold bg-white"} 
