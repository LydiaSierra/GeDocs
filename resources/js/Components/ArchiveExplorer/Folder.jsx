        ...
        <>
            {gridView ?
                <div
                    ...
                    className={`cursor-pointer border-b lg:border  shadow-sm  select-none lg:hover:shadow-md relative transition p-2 flex  items-center justify-between rounded-md w-full active:bg-[#E8F9FB]  ${isSelected(folder.id, 'folder') ? "bg-primary/30" : "bg-white hover:bg-primary/20"}`}
                >
