    ...
    return (
        ...
        >
            <li><button className="p-3 border-b border-gray-300" onClick={(e) => {
                e.preventDefault();
            }}><FolderPlusIcon className="w-5 h-5 fill-green-800 stroke-white" /> Editar archivo</button></li>
            <li><a className="p-3 border-b border-gray-300"><DocumentPlusIcon className="w-5 h-5 fill-green-800 stroke-white" />Eliminar archivo</a></li>
        </ul>
    )
}

export default RightClickFile